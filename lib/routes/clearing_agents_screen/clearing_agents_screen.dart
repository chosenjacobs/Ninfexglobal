...
import '../service_provider_profile/service_provider_profile.dart';

class ClearingAgentsScreen extends StatelessWidget {
  const ClearingAgentsScreen({super.key});
                    ...
                    Expanded(
                      ...
                      child: TextField(
                        decoration: InputDecoration(
                          hintText: 'Search clearing agents...',
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return _AgentCard(
                  name: 'Agent ${index + 1}',
                  company: 'Clearing Company ${index + 1}',
                  rating: 4.5,
