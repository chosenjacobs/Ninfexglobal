...
class FlightAgentsScreen extends StatelessWidget {
  const FlightAgentsScreen({super.key});
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const ChatDetailsScreen(name: 'Flight Agent',),
                          ),
                        );
                      },
